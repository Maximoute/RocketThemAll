...
- Le moteur des 9 boss standards et des 8 gardiens est branché : boss standard quotidien de 24 heures, gardiens de progression selon leur créneau configurable, activation/expiration persistantes, cinq mécaniques, catégories déterministes, effet d’invasion temporaire, contributions atomiques par crédits/fragments/doublons/cartes présentées/captures et déblocage du monde suivant.
