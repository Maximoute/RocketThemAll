...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-rta-surface via-rta-surface2 to-rta-bg border border-rta-border rounded-2xl p-8 sm:p-12 text-center mb-6 overflow-hidden">
