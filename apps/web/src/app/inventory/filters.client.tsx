...
export default function InventoryFiltersClient({ decks, rarities, categories, initial }: Props) {
  ...
  return (
    <form
      className="bg-rta-surface border border-rta-border rounded-xl p-3 flex gap-3 flex-wrap items-center mb-4"
    ...
    >
      <input
        ...
        className="bg-rta-bg border border-rta-border rounded-lg px-3 py-1.5 text-sm text-rta-ink placeholder:text-rta-muted flex-1 min-w-[160px] focus:outline-none focus:border-rta-accentHi"
      />
